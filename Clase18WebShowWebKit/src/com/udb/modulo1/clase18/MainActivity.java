	...
	public void onActivityResult(int request, int result, Intent intent){
		try{
			...
			if(mime.contains("image")){
				html2="<img src="+uri.toString()+">";
				msg="Se ha cargado la imagen <br />";
			}else{
				html2 = "<audio controls><source src='"+uri.toString()+"' type='audio/ogg'>Your browser does not support the audio element.</audio>";
				msg="Se ha cargado el audio <br />";
			}
			...
			html1 = "<b>No se ha cargado nada</b>";
		}
		webSide1.loadData(html1, "text/html", "utf-8");
	}
